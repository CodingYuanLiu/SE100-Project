...
export default {
  ...
  methods: {
    ...
    getBlog(page) {
      ...
      query.find().then(blogs => {
        ...
        blogs.forEach((blog, index) => {
          this.blogs.push({
            id: blog.id,
            memcontent: blog.attributes.memcontent,
            foodcontent: blog.attributes.foodcontent,
            carcontent: blog.attributes.carcontent,
            tel: blog.attributes.tel,
    ...
    changePage(newPage) {
      ...
      this.$router.push({ name: 'allfood', query: { page: newPage } });
    }
  },
}
